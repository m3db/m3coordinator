...
$GOPATH/src/github.com/influxdata/influxdb-comparisons/cmd/bulk_data_gen/bulk_data_gen -timestamp-start=$start -timestamp-end=$end -scale-var=10 -seed=$seed > $GOPATH/src/github.com/influxdata/influxdb-comparisons/cmd/bulk_data_gen/benchmark_influx && $GOPATH/src/github.com/influxdata/influxdb-comparisons/cmd/bulk_data_gen/bulk_data_gen -format=opentsdb -timestamp-start=$start -timestamp-end=$end -scale-var=10 -seed=$seed > $GOPATH/src/github.com/influxdata/influxdb-comparisons/cmd/bulk_data_gen/benchmark_opentsdb
